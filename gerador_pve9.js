...
// 📁 PASTA 9: O FUNIL QUÁDRUPLO SUPREMO (250x RNG)
const pastaDestino = path.join(__dirname, 'json', 'simulacao_pve9');
...
// 4. FUNÇÃO PRINCIPAL (O QUÁDRUPLO FUNIL: M6 -> M7 -> M8 -> M9)
async function gerarRankingEmMassa(bossesInput, tiersInput) {
    ...
    for (let i = 0; i < listaBosses.length; i++) {
        ...
        for (const currentTier of tiersToRun) {
            ...
            console.log(`\n========================================================`);
            console.log(`👑 MOTOR 9.0 (O FUNIL SUPREMO): ${bossData.speciesName.toUpperCase()}`);
            console.log(`========================================================`);
            ...
            for (let c = 0; c < cenariosDeLuta.length; c++) {
                ...
                // =======================================================
                // 💎 ESTÁGIO 3: MOTOR 8.0 (RNG 100x -> Peneira 125)
                // =======================================================
                let resultadosM8 = [];
                let c3 = 0;
                ...
                // 🚨 O NOVO FILTRO ESTRITO PARA O M9 (TOP 125)
                ...
                // =======================================================
                // 👑 ESTÁGIO 4: MOTOR 9.0 SUPREMO (RNG 250x ABSOLUTO)
                // =======================================================
                ...
                listaM9.forEach(combo => {
                    ...
                    const simular = instanciarCombate(atacanteObj, oponenteRaid, combo.f, combo.c, configRaid.tempo);
                    if(simular) {
                        const m9Data = rodarMonteCarlo(simular, 250); // 🚨 O Teste Supremo de 250 Lutas!
                        resultadosFinais.push({
                            i: atacanteObj.speciesId, n: atacanteObj.speciesName, f: combo.f.replace("_FAST", ""), c: combo.c, ...m9Data
                        });
                    }
                });
                console.log();
            ...
            console.log(`\n✅ ARQUIVO 9.0 GERADO: ${nomeDoArquivo} (${tamanhoKB} KB)`);
        }
    }
}
...
console.log("========================================================");
console.log("👑 GERADOR PVE 9.0 (QUÁDRUPLO FUNIL + MONTE CARLO 250x) 👑");
console.log("========================================================\n");

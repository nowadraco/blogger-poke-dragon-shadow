...
async function carregarTodaABaseDeDados() {
    try {
        ...
        // Dicionário de traduções (formato antigo, que funciona com o código abaixo)
...
function displayPokemonList(pokemonList) {
    ...
    const renderList = (list) => {
        ...
        list.forEach((pokemon) => {
            // Não precisa mais chamar buscarDadosCompletosPokemon aqui!
            // Todos os dados, incluindo a imagem, já estão no objeto 'pokemon'.
            ...
            // O fallback de imagem ainda é importante.
...
function showPokemonDetails(dexNumber) {
    ...
    // Usa a lista completa para encontrar o Pokémon, garantindo que a navegação funcione sempre
    ...
    // Função interna para processar cada movimento na hora
    const criarHtmlDoMovimento = (moveId) => {
        ...
        // A tradução agora usa o `dadosMovimento.name` (ex: "Razor Leaf")
...
async function main() {
    ...
    // Adicione outras chamadas processarListas aqui se precisar

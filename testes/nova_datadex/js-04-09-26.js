...
window.verBatalha = function (posicao) {
  ...
  // =================================================================
  console.log(
    "%c🔍 RAIO-X DOS GOLPES (Leitura Bruta do JSON)",
    "background: #8e44ad; color: white; font-weight: bold; font-size: 14px; padding: 4px; border-radius: 4px;",
  );
  console.table({
    "Ataque Rápido": {
      Nome: nomeFast,

...
window.showPokemonDetails = async function (
  ...
  function calcularMelhoresCounters(defensor, criterio = "estimador") {
    ...
    allPokemonDataForList.forEach((atacante) => {
      ...
      if (atacante.speciesId === defensor.speciesId || atacante.speciesName.includes("Purified") || atacante.speciesName === "Smeargle" || atacante.speciesName === "Ditto" || atacante.speciesName.startsWith("Mega ")) {
        return;
      }
      ...
      if (combos && combos.length > 0) {
        ...
        combos.forEach(combo => {
          ...
          let danoDe6 = tempoDeVidaDe6 >= tempoRaid ? Math.max(0, tempoRaid - (tempoRaid/tempoDeVidaSingle)*2) * dps : 6 * tdo;
          ...
          if (criterio === "dps") {
            ...
            if (estimador < agrupadoPorPokemon[atacante.speciesId].melhorMetric) agrupadoPorPokemon[atacante.speciesId].melhorMetric = estimador;
          }
        });
      }
    });
 ...
 // ====================================================================
  ...
  // ====================================================================
  window.atualizarListaCountersUI = async function (defensor, criterio = "estimador") {
    ...
    try {
        ...
        window.renderizarPaginaCounters = function (paginaAtual) {
            ...
            itensDaPagina.forEach((c, index) => {
                ...
                const danoCausado = c.dmgPerc !== undefined ? c.dmgPerc.toFixed(1) : "0.0";
                ...
                if (temOutrosGolpes) {
                    ...
                    golpesPraMostrar.forEach(outro => {
                        ...
                        const danoOutro = outro.dmgPerc !== undefined ? outro.dmgPerc.toFixed(1) : "0.0";
                        const mortesOutro = outro.deathsMax !== undefined ? outro.deathsMax : '-';
            ...
            btnBatalha.addEventListener("click", async () => {
                ...
                while (tempoTotalSobrevivido < tempoMaximoRaid && danoTotalDoTime < bossHPMax) {
                    ...
                    for (let i = 0; i < membrosCalculados.length; i++) {
                        ...
                        let tempoParaMatarOBoss = hpRestanteBoss / Math.max(0.1, stats.dpsAjustado);

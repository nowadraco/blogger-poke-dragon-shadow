...
# ====================================================================
ARQUIVOS_CSS = [
    r"testes/counters/blogger_css/css-dentro-do-blogger.css"
]
...
def auditar_css(arquivos):
    ...
    for caminho in arquivos:
        if not os.path.exists(caminho):
            print(f"❌ AVISO: Arquivo não encontrado no caminho:\n{caminho}\nVerifique se o nome da pasta está correto!")
            continue
    ...
    print("\n" + "="*60)
    print("🚨 RESULTADO: SELETORES DUPLICADOS NESTE ARQUIVO 🚨")
    print("="*60 + "\n")
    
    if not duplicados_ordenados:
        print("✅ Parabéns! O seu código está limpo, nenhum seletor CSS repetido foi encontrado dentro desse arquivo.")
        return
    ...
    with open("relatorio_duplicidades_css.txt", "w", encoding="utf-8") as f_out:
        f_out.write("🚨 RELATÓRIO DE SELETORES CSS REPETIDOS 🚨\n")
        f_out.write("Você usou essas mesmas classes mais de uma vez dentro do mesmo arquivo!\n")
        f_out.write("="*60 + "\n\n")
